...
def caldaynight(origin:str, dest:str, airborne_UTC:str, landing_UTC:str, departure_date:str, off_block_UTC:str, on_block_UTC:str, shitRest:bool = True, P2X:bool = True):
    ...
    for lon, lat in routepts:
        ...
        # daytime
        if (sunrise_next == "PD" or sunset_prev == "PD" or sunrise == "PD" or sunset == "PD"
                or sunrise < cur_time < sunset or cur_time > sunrise_next or cur_time < sunset_prev):
    ...
    # For P2X only
    # if total ignored taxi time is less than block_minus_hour (default: 1 hr),
    # deduct day and night hour up to (block time - block_minus_hour)/2.
